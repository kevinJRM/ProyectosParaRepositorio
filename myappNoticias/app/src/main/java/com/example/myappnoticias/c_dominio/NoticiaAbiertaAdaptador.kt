...
class NoticiaAbiertaAdaptador : RecyclerView.Adapter<NoticiaAbiertaViewHolder>() {

    private var items : MutableList<Articulo> = ArrayList<Articulo>()
    private val scope = CoroutineScope(GlobalScope.coroutineContext)
    var indicadorCierre : MutableLiveData<String> = MutableLiveData<String>()
    ...
    override fun onBindViewHolder(holder: NoticiaAbiertaViewHolder, position: Int) {
        ...
        holder.botonCerraNoticia.setOnClickListener(){
            indicadorCierre.postValue("CerrarNoticia")
        }
        ...
        holder.botonGuardar.setOnClickListener(){
            scope.launch {
                kotlin.runCatching {
                    ...
                    Log.d("TAG","NoticiaAbiertaAdaptador-onBindViewHolder - guardado con exito "+it)
                }.onFailure {
                    Log.d("TAG","NoticiaAbiertaAdaptador-onBindViewHolder - fallo el guardado "+it)
                }
            }
        }
